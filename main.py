...
pygame.display.set_caption("SpAcEsHiPs R sOoOo CoOl")
...
def shoot_bullets(yellow_bullets, red_bullets, yellow, red):
    for bullet in yellow_bullets:
        bullet.x += BULLET_VEL
...
def main():
    yellow = pygame.Rect(100, 200, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)   # Height and width are swapped due to rotation on line 22
    red = pygame.Rect(700, 200, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)      # Height and width are swapped due to rotation on line 25
    ...
    while run:
        ...
        shoot_bullets(yellow_bullets, red_bullets, yellow, red)
